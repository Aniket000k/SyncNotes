...
const Sidebar = ({ notes, selectedNote, onSelectNote, onCreateNote, onDeleteNote, isOpen, onToggle }) => {
  ...
  return (
    <div className="relative">
      {/* Mobile Header */}
      <div className={`md:hidden fixed top-0 left-0 right-0 h-16 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} z-20 flex items-center px-4 border-b`}>
        <button
          onClick={onToggle}
      ...
      <div 
        ...
        } ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} z-20 shadow-lg`}
      >
